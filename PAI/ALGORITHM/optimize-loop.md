...
Optimize mode accepts tunable parameters that control mutation boldness, regression tolerance, and patience. Full schema: `~/.config/opencode/PAI/PAI/ALGORITHM/parameter-schema.md`.
