...
Parameters control ideation behavior along a spectrum from pure free-form dreaming to tight analytical focus. Full schema: `~/.config/opencode/PAI/PAI/ALGORITHM/parameter-schema.md`.
