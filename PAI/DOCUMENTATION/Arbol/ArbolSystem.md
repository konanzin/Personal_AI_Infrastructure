...
1. Create directory: `mkdir ~/.config/opencode/PAI/PAI/USER/ACTIONS/A_YOUR_ACTION`
...
5. Deploy to cloud (optional): add Worker under `~/.config/opencode/PAI/PAI/USER/ARBOL/Workers/a-your-action/`, then `bash deploy.sh a-your-action`
...
Local pipeline definitions live in `~/.config/opencode/PAI/PAI/ARBOL/Pipelines/[Domain]_[Pipeline-Name]/PIPELINE.md`:
...
- **Local directory:** `~/.config/opencode/PAI/PAI/ARBOL/Pipelines/[Domain]_[Pipeline-Name]/PIPELINE.md`
...
2. Create directory: `mkdir -p ~/.config/opencode/PAI/PAI/ARBOL/Pipelines/[Domain]_[Pipeline-Name]`
...
```bash
cd ~/.config/opencode/PAI/PAI/USER/ARBOL
...
|----------|------|-------------|
| Source Code | `~/.config/opencode/PAI/PAI/USER/ARBOL/` | Cloudflare Workers source repository |
...
| System Actions | `~/.config/opencode/PAI/PAI/ARBOL/Actions/` | Framework actions (examples) |
| System Pipelines | `~/.config/opencode/PAI/PAI/ARBOL/Pipelines/` | Framework pipelines (examples) |
| System Flows | `~/.config/opencode/PAI/PAI/ARBOL/Flows/` | Framework flows (examples) |
| Personal Actions | `~/.config/opencode/PAI/PAI/USER/ACTIONS/` | User-defined actions (override system) |
| Personal Pipelines | `~/.config/opencode/PAI/PAI/USER/PIPELINES/` | User-defined pipelines (override system) |
| Personal Flows | `~/.config/opencode/PAI/PAI/USER/FLOWS/` | User-defined flows (override system) |
