...
**Primary Skill:** `~/.config/opencode/PAI/skills/Fabric/SKILL.md`
...
**Patterns Location:** `~/.config/opencode/PAI/skills/Fabric/Patterns/` (240+ patterns)
...
-> Runs fabric -U
-> Syncs to ~/.config/opencode/PAI/skills/Fabric/Patterns/
```

**Manual:**
```bash
fabric -U && rsync -av ~/.config/fabric/patterns/ ~/.config/opencode/PAI/skills/Fabric/Patterns/
```
...
- **Full Skill:** `~/.config/opencode/PAI/skills/Fabric/SKILL.md`
- **Pattern Execution:** `~/.config/opencode/PAI/skills/Fabric/Workflows/ExecutePattern.md`
- **Pattern Updates:** `~/.config/opencode/PAI/skills/Fabric/Workflows/UpdatePatterns.md`
- **All Patterns:** `~/.config/opencode/PAI/skills/Fabric/Patterns/`
- **Architecture:** `~/.config/opencode/PAI/PAI/DOCUMENTATION/PAISystemArchitecture.md` — Master PAI architecture reference
