...
- Constitutional rules (what the DA must always do): [`../RUNTIME_CONSTITUTION.md`](../RUNTIME_CONSTITUTION.md)
...
|----------|----------------|
| [`RUNTIME_CONSTITUTION.md`](../RUNTIME_CONSTITUTION.md) | Constitutional rules the DA must follow |
