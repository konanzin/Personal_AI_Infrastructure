...
```
~/.config/opencode/PAI/PAI/MEMORY/WORK/{slug}/ISA.md
```
...
- **Reference file pattern**: This spec lives at `~/.config/opencode/PAI/PAI/DOCUMENTATION/IsaFormat.md`, not inline in CLAUDE.md. Saves ~2,500 tokens/response.
