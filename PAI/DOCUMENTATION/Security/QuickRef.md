...
**Bash commands:** `rm -rf /`, `~`, `~/.claude`, `~/.config/opencode/PAI/PAI`, `~/Projects` | disk ops | `gh repo delete/visibility public` | credential strings in outbound commands | pipe to shell
