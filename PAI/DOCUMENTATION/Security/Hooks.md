...
- **File:** `~/.config/opencode/PAI/hooks/SecurityPipeline.hook.ts`
...
- **File:** `~/.config/opencode/PAI/hooks/ContentScanner.hook.ts`
...
- **Type:** Command hook (subprocess)
- **File:** `~/.config/opencode/PAI/hooks/SmartApprover.hook.ts`
...
- **Architecture:** Three-tier classification:
  1. Trusted workspace paths (~/.config/opencode/PAI/, ~/Projects/, ~/LocalProjects/) → auto-approve (no LLM)
...
- **Type:** Command hook (subprocess)
- **File:** `~/.config/opencode/PAI/hooks/PromptGuard.hook.ts`
...
- **Type:** Command hook (subprocess)
- **File:** `~/.config/opencode/PAI/hooks/ConfigAudit.hook.ts`
