...
```bash
bun ~/.config/opencode/skills/Webdesign/Tools/DriveClaudeDesign.ts prompt "$(cat /tmp/brief.md)"
```
...
mkdir -p "$OUT"
bun ~/.config/opencode/skills/Webdesign/Tools/DriveClaudeDesign.ts screenshot "$OUT/v1.png"
```
...
```bash
bun ~/.config/opencode/skills/Webdesign/Tools/DriveClaudeDesign.ts export bundle "$OUT"
```

### 7. Verify

```bash
bun ~/.config/opencode/skills/Webdesign/Tools/VerifyDesign.ts "$OUT/index.html" "$OUT/verify"
```
...
- One-line entry in `~/.config/opencode/`
