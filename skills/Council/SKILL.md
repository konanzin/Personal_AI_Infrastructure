...
- **Council uses the Agents skill (ComposeAgent) for custom agents — NOT built-in agent types.** Never use built-in agent types (Explore, Cato, etc.) for Council debates.
