...
Patterns are managed by the Fabric skill at `~/.config/opencode/skills/Fabric/`.
...
**Fabric Skill:** `~/.config/opencode/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `~/.config/opencode/skills/Fabric/Patterns/official_pattern_template/`
