...
prompt: |
  ...
  **BEFORE ANY WORK, YOU MUST:**
  ...
  curl -s --max-time 2 -X POST http://localhost:31337/notify \
    ...
    -d '{"message":"Loading Perplexity Researcher context - preparing investigative analysis","language":"en-US","voice_id":"AXdMgz6evoL7OPd7eU12","title":"Ava Chen"}' >/dev/null 2>&1 || true
  ```
