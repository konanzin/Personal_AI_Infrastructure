...
Current score: **158/158 passing** (80 structural + 67 behavioral + 11 E2E). Parity estimate: **~90-95% over the core scope** — see `REPO_MODEL.md` → "Out of Scope by Design" for what is deliberately excluded.
